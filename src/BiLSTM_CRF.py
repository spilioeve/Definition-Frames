...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, labels, vocab_size, pos_size, chunk_size, embedding_dim, hidden_dim, number_layers, batch_Size):
        ...
        self.lstm = nn.LSTM(embedding_dim + 21, hidden_dim // 2,
                            num_layers=number_layers - 1, bidirectional=True, batch_first=True)
    ...
    def init_hidden(self):
        hidden1= torch.randn(self.number_layers, self.batch_Size, self.hidden_dim // 2)
        hidden2 = torch.randn(self.number_layers, self.batch_Size, self.hidden_dim // 2)
